  ...
  <div class="row">
    <div class="col-md-12">
      <ul class="nav nav-pills flex-column flex-md-row mb-3">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="edit_product_1.php"
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <form id="formAccountSettings" method="POST" action="edit_product_3.php" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="mb-3 col-md-6">
                ...
                <select id="category" class="select2 form-select" name="cat_id" required>
                  <?php
                    ...
                    while ($category = mysqli_fetch_assoc($rs2)) {
                    ?>
                      <option value="<?php echo $category['cat_id'] ?>"
                        <?php echo $row['cat_id'] == $category['cat_id'] ? 'selected=selected':''; ?>>
              ...
              <div class="mb-3 col-md-6">
                ...
                <div class="input-group input-group-merge">
                  <select id="type" class="select2 form-select" name="type_id" required>
                    <?php
                      $sql3 = "select type_id, type_name from type";
                      $rs3 = $mysqli->query($sql3);

                      while ($type = mysqli_fetch_assoc($rs3)) {
                      ?>
                        <option value="<?php echo $type['type_id'] ?>"  <?php echo $row['type_id'] == $type['type_id'] ? 'selected=selected':''; ?>><?php echo $type['type_name'] ?></option>
                      <?php
                      }
                      ?>
                  </select>
              ...
              <div class="mb-3 col-md-6">
                ...
                <textarea class="form-control"name="p_description" id="description" rows="8" cols="80"><?php echo $row['p_description'] ?></textarea>
              </div>
          ...
          <?php
            ...
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
              ...
              <a href="edit_product_1.php" class="btn btn-danger">Try again</a>
            </div>
