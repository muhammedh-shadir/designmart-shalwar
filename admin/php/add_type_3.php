  ...
  <div class="row">
    <div class="col-md-12">
      <ul class="nav nav-pills flex-column flex-md-row mb-3">
        <li class="nav-item">
          <a class="nav-link active" href="add_type_1.php"><i class="bx bx-add-to-queue me-1"></i> Add Product type</a>
        </li>
        <li class="nav-item">
        ...
        <div class="card-body">
          <?php
           ...
           <div class="alert alert-success alert-dismissible fade show" role="alert">
             <p><strong>Congratulations!</strong> Product Type Added Successfully.</p>
             <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
             <a href="add_type_1.php" class="btn btn-success">Add another product type</a>
           </div>
           ...
           <?php
              ...
              <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <p><strong>Sorry!</strong> Adding Product Type Failed.</p>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                <a href="add_type_1.php" class="btn btn-danger">Try again</a>
              </div>
